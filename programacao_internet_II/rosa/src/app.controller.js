...
var AppController = exports.AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.hello = function (nome) {
            if (nome === void 0) { nome = 'Visitante'; }
            var context = {
                nome: nome,
    ...
    (function () {
        _hello_decorators = [(0, common_1.Get)('/'), (0, common_1.Render)('index')];
        __esDecorate(_classThis, null, _hello_decorators, { kind: "method", name: "hello", static: false, private: false, access: { has: function (obj) { return "hello" in obj; }, get: function (obj) { return obj.hello; } } }, null, _instanceExtraInitializers);
