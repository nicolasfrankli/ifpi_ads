...
namespace comercio.Controllers
{
    public class PagamentoComCartaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,numeroDoCartao,bandeira")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,numeroDoCartao,bandeira")] PagamentoComCartao pagamentoComCartao)
        {
